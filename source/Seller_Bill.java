 ...
 */
public class Seller_Bill extends javax.swing.JFrame {

    /**
     * Creates new form Seller_Bill
     */
    public Seller_Bill() {
        initComponents();
        SelectBill();
    ...
    public void SelectBill(){
        try {
            ...
            ResultSet Rs = null;
            Rs = St.executeQuery("select * from supermarket.seller_bill");
...
>>>>>>> 1bd4629 (first commit)
    ...
    private void FilterBtnMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_FilterBtnMouseClicked
        try {
            ...
            if(SearchNameLbl.getText().length() > 0){
                Rs = St.executeQuery("select * from supermarket.seller_bill where substring(seller_acc, 1, "+
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Seller_Bill.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
